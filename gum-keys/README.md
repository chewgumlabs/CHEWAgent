...
It has no private endpoints, no workspace assumptions, and no status command.
It only adds lightweight guidance to the brain prompt:
...
The default public install still works without a key. This file exists as a
